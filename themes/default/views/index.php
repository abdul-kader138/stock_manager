				...
				<table class="table table-bordered dash">
					<tbody>
						<tr>
							...
							<td class="text-center btn-theme03"><a href="<?= site_url('check_in'); ?>"><i class="fa fa-arrow-circle-up"></i> <span><?= lang('check_in_items'); ?></span></a></td>
							<td class="text-center btn-theme03"><a href="<?= site_url('check_out'); ?>"><i class="fa fa-arrow-circle-down"></i> <span><?= lang('check_out_items'); ?></span></a></td>
							<?php if($Admin) { ?>
					...
					<div class="box box-primary">
						...
						<?php if($Admin){ ?>
						 ...
						 <div class="form-group">
								...
								$disabled = '';
								if(!$Admin){ $disabled =  'disabled'; }
                                ?>
                                <?= form_dropdown('store', $st, set_value('store', $store_id), 'class="form-control tip" onchange="javascript: document.getElementById(\'store-form\').submit()" id="store" '.$disabled); ?>
                            </div>
							</form>
							<?php } ?>	
