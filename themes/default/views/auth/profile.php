                            ...
                            <div class="panel-body" style="padding: 5px;">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
										...
										<div class="form-group  <?php echo (($user->group_id == 2) ? '' : 'hidden') ?>">
                                            <?= lang("store", "store"); ?>
                                            <?php
                                            $st[""] = "";
                                            ...
                                            echo form_dropdown('store', $st, (isset($_POST['store']) ? $_POST['store'] : $user->store_id), 'id="store" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("store") . '" class="form-control input-tip select" style="width:100%;"');
                                            ?> 
                                        </div>
