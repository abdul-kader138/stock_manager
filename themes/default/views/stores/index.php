...
<div class="">
    <h3><i class="fa fa-users"></i> <?=$page_title;?><a href="<?=site_url('stores/add')?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> <?=lang('add_store');?></a></h3>
            ...
            <div class="content-panel">
                <div class="table-responsive">
                    <table id="CuData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            <th><?= lang("id"); ?></th>
                            <th class="col-xs-3"><?= lang("store_name"); ?></th>
