                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <?= lang('date', 'date'); ?>
                                <?= form_input('date', set_value('date', $check_out->date), 'class="form-control tip datetime" id="date"  required="required"'); ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6"  >
                            <div class="form-group">
                                ...
                                ?>
                                <?= form_dropdown('store', $st, set_value('store', $check_out->store_id), 'class="form-control tip" id="store" '.$disabled); ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        store('stoutitems', JSON.stringify(<?= $items; ?>));
        loadInItems();
    });
</script>
